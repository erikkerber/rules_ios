...
def _populate_xcodeproj_targets_and_schemes(ctx, targets, src_dot_dots, all_transitive_targets):
    ...
    for target_info in targets:
        ...
        build_target_to_scheme_info = {scheme_info.scheme_build_action_target: scheme_info for scheme_info in scheme_infos}
        ...
        if target_info.product_type == "bundle.unit-test":
            ...
            xcodeproj_schemes_by_name[target_name]["test"] = {
                "targets": scheme_info_for_target.scheme_test_action_targets,
                "customLLDBInit": lldbinit_file,
                "environmentVariables": [
                    ...
                    for target in scheme_info_for_target.scheme_test_action_targets
...
""",
    attrs = {
        ...
        "additional_scheme_infos": attr.label_list(mandatory = False, allow_empty = True, providers = [], aspects = [], doc = "TODO"),
