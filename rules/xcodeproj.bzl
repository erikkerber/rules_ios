...
"""),
        ...
        "ld_stub": attr.label(executable = True, default = Label("//tools/xcodeproj_shims:ld_stub_nbs"), cfg = "host"),
        "swiftc_stub": attr.label(executable = True, default = Label("//tools/xcodeproj_shims:swiftc_stub_nbs"), cfg = "host"),
